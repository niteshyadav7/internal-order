...
import { ArrowUp, ArrowDown, ArrowUpDown, Edit2, Trash2, Loader2 } from 'lucide-react';
      ...
      <div className="overflow-x-auto">
        {loading ? (
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-100 dark:border-zinc-800/80 bg-slate-50/50 dark:bg-zinc-950/20 text-slate-405 text-[10px] uppercase font-black tracking-wider select-none">
