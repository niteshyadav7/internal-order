      ...
      {prepOrder && (
        ...
        >
          <div 
            ...
            className="bg-white dark:bg-zinc-900 w-full max-w-2xl sm:rounded-3xl shadow-2xl flex flex-col min-h-screen sm:min-h-[85dvh] max-h-screen sm:max-h-[90dvh] overflow-hidden border border-slate-200 dark:border-zinc-800 animate-in zoom-in-95 duration-200 cursor-default"
          >
